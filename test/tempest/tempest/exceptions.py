        ...
        #zfl add : get related opencos log
            try:
                ...
                if 'server' in self._error_string.lower():
                    obj_type = "server"
                if sresult:
                        log_result = log_obj.get_opencos_log(sresult, obj_type=obj_type)
                else:
                        log_result = log_obj.get_opencos_log([], obj_type=obj_type)
                        log_result = "\n--------- <no keywords, display some logs containing Error or Fail>\n" + log_result
                self._error_string =  self._error_string + "\n\n\n================ possible opencos log ===========" + \
                                                                                          log_result  + \
                                                                                          "\n\n================ possible opencos log end=========\n\n\n"
