...
class ServersClientJSON(service_client.ServiceClient):
    ...
    def create_server(self, name, image_ref, flavor_ref, **kwargs):
        ...
        for option in ['personality', 'adminPass', 'key_name',
            ...
            #zfl add net-id in create_server(if no networks provided,use uuid=internal_network_id)
            else:
                if key == "networks":
    ...
    def evacuate(self, server_id, **kwargs):
        return self.action(server_id, 'evacuate', 'adminPass',
