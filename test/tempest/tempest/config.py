...
ComputeGroup = [
    ...
    #jianghuaicheng add image_rf&user 2015.4.1
    cfg.StrOpt('image_ref_xp',
               help="Valid XP image reference to be used in tests. "
                    "This is a required option"),
    cfg.StrOpt('image_ssh_xp_user',
               default="administrator",
               help="User name used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ssh_xp_pwd',
               default="null",
               help="Password used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ref_vmb',
               help="Valid VMB image reference to be used in tests. "
                    "This is a required option"),
    cfg.StrOpt('image_ssh_vmb_user',
               default="zte",
               help="User name used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ssh_vmb_pwd',
               default="zte",
               help="Password used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ref_linux',
               help="Valid Linux-CGSLV5 image reference to be used in tests. "
                    "This is a required option"),
    cfg.StrOpt('image_ssh_linux_user',
               default="root",
               help="User name used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ssh_linux_pwd',
               default="ossdbg1",
               help="Password used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ref_suse',
               help="Valid SUSE image reference to be used in tests. "
                    "This is a required option"),
    cfg.StrOpt('image_ssh_suse_user',
               default="root",
               help="User name used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ssh_suse_pwd',
               default="it@123456",
               help="Password used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ref_centos7',
               help="Valid CENTOS7 image reference to be used in tests. "
                    "This is a required option"),
    cfg.StrOpt('image_ssh_centos7_user',
               default="root",
               help="User name used to authenticate to an instance using "
                    "the alternate image."),
    cfg.StrOpt('image_ssh_centos7_pwd',
               default="ossdbg1",
               help="Password used to authenticate to an instance using "
                    "the alternate image."),                    
    #jianghuaicheng add end
    #zfl add sdn
    cfg.BoolOpt('use_sdn',
               default=False,
               help="whether use SDN."),       
    #zfl add end           
...
#zfl add config item              
    cfg.StrOpt('fixed_network_name_external',
               default='private',
               help="Visible fixed network name external "),                                      
#zfl add end           
#lvfumei add config item
    cfg.StrOpt('multi_create_flavor_id',
               default='3',
               help="Valid flavor reference to be used in multiple create servers. "
                    "This is a required option"),
    cfg.IntOpt('multi_create_max_count',
               default=5,
               help="Max count of multiple creating servers."),
    cfg.StrOpt('v4_image_file',
               default='',
               help="V4 image file where stored."),
#lvfumei add end
...
ScenarioGroup = [
    ...
    #zfl add               
    cfg.StrOpt('img_file_2', deprecated_name='qcow2_img_file_2',
               default='winxp.img',
               help='Image file name 2'),
...
#added by jianghuaicheng 2015.4.13
tecs_group = cfg.OptGroup(name='tecs', title="TECS Test Options")
...
TecsGroup = [
    ...
    cfg.StrOpt('host_password',
               help="host password"),
    cfg.StrOpt('v4_flavor_id',
               help="V4 flavor for V4 image tests"),
    cfg.StrOpt('v4_omcnet_id',
               help="V4 omcnet - flat for V4 VM tests"),
    cfg.StrOpt('v4_basenet_id',
               help="V4 basenet - vlan  for V4 VM tests"),
    cfg.StrOpt('v4_fabricnet_id',
               help="V4 fabricnet for V4 VM tests"),
    cfg.StrOpt('v4_outnet_id',
               help="V4 outnet for V4 VM tests"),
    cfg.StrOpt('network_image_id',
               help="Network image for network tests"),
    cfg.StrOpt('network_flavor_id',
               help="Network flavor for network tests"),
    cfg.StrOpt('network_ssh_user',
               help="Network SSH user for network tests"),
    cfg.StrOpt('network_ssh_pwd',
               help="Network SSH password for network tests"),
    cfg.StrOpt('network_server_ipaddr',
               help="Network outside server ip address for network tests"),
    cfg.StrOpt('network_server_ssh_user',
               help="Network outside server SSH user for network tests"),
    cfg.StrOpt('network_server_ssh_pwd',
               help="Network outside server SSH password for network tests"),
    cfg.StrOpt('network_server_ftp_user',
               help="Network outside server FTP user for network tests"),
    cfg.StrOpt('network_server_ftp_pwd',
               help="Network outside server FTP password for network tests"),
    cfg.StrOpt('network_lb_provider',
               help="Network lbaas provider"),
]

daisy_group = cfg.OptGroup(name='daisy', title="Daisy Test Tecs")
DaisyGroup = [
    cfg.StrOpt('daisy_endpoint',
               default='',
               help="daisy_endpoint"),
    cfg.StrOpt('cluster_id',
               default='',
               help="cluster_id"),
    cfg.StrOpt('install_ha_ip',
               default='',
               help="install_ha_ip"),
    cfg.StrOpt('install_ha_netmask',
               default='',
               help="install_ha_netmask"),
    cfg.StrOpt('install_ha_vip',
               default='',
               help="install_ha_vip"),
    cfg.StrOpt('time_out',
               default=1080,
               help="time_out"),
    cfg.StrOpt('install_ha_eth_name',
               default='',
               help="install_ha_eth_name"),
    cfg.StrOpt('install_ha_mac',
               default='',
               help="install_ha_mac")
]
...
_opts = [
    ...
    #added by jianghuaicheng 2015.4.13
    (tecs_group, TecsGroup),
    (daisy_group,DaisyGroup)
]
...
class TempestConfigPrivate(object):
    ...
    def _set_attrs(self):
        ...
        _CONF.set_default('alt_domain_name', self.identity.admin_domain_name,
                          group='identity')
        #added by jianghuaicheng 2015.4.13
        self.tecs = cfg.CONF.tecs
        self.daisy = cfg.CONF.daisy
