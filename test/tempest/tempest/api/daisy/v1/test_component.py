...
class DaisyComponentTest(base.BaseDaisyTest):
    ...
    def resource_setup(cls):
        ...
        cls.component_meta={'name':'test_component','description':'test'}
    ...
    def test_list_component(self):
        ...
        component_list = ["camellia","ha","loadbalance","amqp","database","keystone","ironic","neutron",      "horizon","ceilometer","glance","heat","nova","cinder"]
