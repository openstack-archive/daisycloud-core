...
class DaisyServiceTest(base.BaseDaisyTest):
    ...
    def test_list_service(self):
        ...
        service_list = ["lb","ha","mariadb","amqp","ceilometer-central","ceilometer-alarm","ceilometer-notification","ceilometer-collector","heat-engine","ceilometer-api","heat-api-cfn","heat-api","horizon","neutron-metadata","neutron-dhcp","neutron-server","neutron-l3","keystone","cinder-volume","cinder-api","cinder-scheduler","glance","ironic","compute","nova-cert","nova-sched","nova-vncproxy","nova-conductor","nova-api"]
