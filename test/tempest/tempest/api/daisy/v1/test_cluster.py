...
class TecsClusterTest(base.BaseDaisyTest):
    ...
    #def test_list_cluster_filter_by_limit(self):
        #filter_cluster_meta = {'limit': "10"}
        #clusters = self.list_clusters(**filter_cluster_meta)
    
    def test_delete_cluster(self):
        """
            STC-F-Daisy_Cluster-0003
            ɾ��һ����Ⱥ��������
        """
        cluster_info1 = self.add_cluster(**self.cluster_meta1)
        cluster_info5 = self.add_cluster(**self.cluster_meta5)
    ...
    def test_add_cluster_with_neutron_parameters(self):
        """
            STC-F-Daisy_NeutronConfSet-0001
            ���neutron���õ�daisy
        """
        #set_trace()
        self.private_network_add()
    ...
    #def test_add_cluster_no_clustername(self):
    #    """   
    #        STC-F-Daisy_Cluster-0012
    #         ���Ӽ�Ⱥ��Ϊ�յļ�Ⱥ  
    #    """
    #    self.private_network_add()
    #    set_trace()
    #    cluster_info = self.add_cluster(**self.cluster_meta3)
    #    #if cluster_info.name is None:
    #    #    self.assertEqual(self.cluster_meta3['name'], cluster_info.name,"cluster add interface is not correct")
    #    #    print "\n ===========cluster_name= %s ", cluster_info.name 
    #    #print "\n ===========STC-F-Daisy_Cluster-0012  run is over  ==============="
    #    #self.delete_cluster(cluster_info.id)
    #    self.assertRaisesMessage(
    #        client_exc.Forbidden,
    #        "cluster name is null!")
    #    #self.ironic_client.physical_node.delete(self.ironic_data_all['uuid'])

    def test_add_cluster_no_description(self):
        """   
            STC-F-Daisy_Cluster-0013
            ����������ϢΪ�յļ�Ⱥ 
        """
        self.private_network_add()
