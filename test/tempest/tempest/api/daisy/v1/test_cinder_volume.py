...
class DaisyCinderVolumeTest(base.BaseDaisyTest):
    ...
    #STC-F-Daisy_Cinder_Volume-0001
    def test_add_cinder_volume(self):
        ...
        self.assertEqual('10.43.177.1,10.43.177.2', cinder_volume_info.management_ips, "test_add_cinder_volume failed")
        self.delete_cinder_volume(cinder_volume_info.id)

    #STC-A-Daisy_Cinder_Volume-0002
    def test_add_same_cinder_volume(self):
        ...
        self.assertRaisesMessage(client_exc.HTTPBadRequest,
                                "400 Bad Request: cinder_volume array disks conflict with cinder_volume %s (HTTP 400)" % cinder_volume_info.id,
                                self.add_cinder_volume, **self.cinder_volume_add_meta)
        self.delete_cinder_volume(cinder_volume_info.id)

    #STC-A-Daisy_Cinder_Volume-0003
    def test_add_cinder_volume_with_wrong_role(self):
        ...
        self.assertRaisesMessage(client_exc.HTTPNotFound,
                                "404 Not Found: The resource could not be found.: Role with identifier af47d81c-7ae4-4148-a801-b4a5c6a52074 not found (HTTP 404)",
                                self.add_cinder_volume, **self.cinder_volume_add_meta)
        del self.cinder_volume_add_meta['role_id']

    #STC-A-Daisy_Cinder_Volume-0004
    def test_add_cinder_volume_with_wrong_driver(self):
        ...
        self.assertRaisesMessage(client_exc.HTTPBadRequest,
                                "400 Bad Request: volume_driver test_driver is not supported (HTTP 400)",
                                self.add_cinder_volume, **self.cinder_volume_add_meta)
        del self.cinder_volume_add_meta['role_id']
        self.cinder_volume_add_meta['disk_array'][0]['volume_driver'] = 'KS3200_FCSAN'

    #STC-F-Daisy_Cinder_Volume-0005
    def test_update_cinder_volume(self):
        ...
        self.assertEqual('10.43.177.3', cinder_volume_update_info.management_ips,"test_update_cinder_volume failed")
        self.delete_cinder_volume(cinder_volume_info.id)

    #STC-A-Daisy_Cinder_Volume-0006
    def test_update_to_same_cinder_volume(self):
        ...
        cinder_volume_add_meta1 = {'disk_array': [{'management_ips':'10.43.177.3,10.43.177.4',
                                                 'pools':'pool1,pool2',
                                                 'user_name':'rooot',
                                                 'user_pwd':'pwd',
                                                 'volume_driver':'KS3200_FCSAN',
        ...
        self.assertRaisesMessage(client_exc.HTTPBadRequest,
                                '400 Bad Request: cinder_volume array disks conflict with cinder_volume %s (HTTP 400)' % cinder_volume_info.id,
                                self.update_cinder_volume, cinder_volume_info1.id, **update_meta)

        self.delete_cinder_volume(cinder_volume_info.id)
        self.delete_cinder_volume(cinder_volume_info1.id)

    #STC-A-Daisy_Cinder_Volume-0007
    ...
    #STC-F-Daisy_Cinder_Volume-0008
    def test_list_cinder_volume(self):
        ...
        query_cinder_volume_list = [cinder_volume_info for cinder_volume_info in list_cinder_volume]
    ...
    #STC-F-Daisy_Cinder_Volume-0009
    def test_get_cinder_volume_detail(self):
        ...
        self.assertEqual("10.43.177.1,10.43.177.2", cinder_volume_detail_info.management_ips, "test_get_cinder_volume_detail failed")
        self.delete_cinder_volume(cinder_volume_info.id)
