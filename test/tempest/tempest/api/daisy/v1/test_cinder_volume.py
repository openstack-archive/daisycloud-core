...
class DaisyCinderVolumeTest(base.BaseDaisyTest):
    ...
    def test_update_cinder_volume(self):
        ...
        cinder_volume_update_info =
            self.update_cinder_volume(cinder_volume_info.id,
    ...
    def test_update_to_same_cinder_volume(self):
        ...
        cinder_volume_info1 =
            self.add_cinder_volume(**cinder_volume_add_meta1)
    ...
    def test_list_cinder_volume(self):
        ...
        query_cinder_volume_list =
            [volume_info for volume_info in list_cinder_volume]
    ...
    def test_get_cinder_volume_detail(self):
        ...
        cinder_volume_detail_info =
            self.get_cinder_volume_detail(cinder_volume_info.id)
        self.assertEqual("10.43.177.1,10.43.177.2",
