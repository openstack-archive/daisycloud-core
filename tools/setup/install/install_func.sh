...
function create_daisy_role_with_kolla
{
    ...
    daisy --os-endpoint="http://${public_ip}:$bind_port" role-add "CONTROLLER" "Controller Role for kolla." --type template --deployment-backend kolla --role-type CONTROLLER >> $install_logfile 2>&1
