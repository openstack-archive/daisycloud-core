...
horizon.network_topology = {
  ...
  show_balloon:function(d,element) {
    ...
    $balloon.find('.delete-device').click(function(e){
      var $this = $(this);
          action_string = html_data.delete_label; 
          name_string = " \"" + html_data.name + "\"";     
          name_string = interpolate(gettext("You have selected %s. "), [name_string]);          
          title = interpolate(gettext("Confirm %s"), [action_string]);
          body = name_string + gettext("Please confirm your selection. ");
    ...
    $balloon.find('.delete-port').click(function(e){
      var $this = $(this);
      action_string = html_data.delete_interface_label; 
      name_string = " \"" + $this.data('port-id') + "\"";     
      name_string = interpolate(gettext("You have selected %s. "), [name_string]);          
      title = interpolate(gettext("Confirm %s"), [action_string]);
      body = name_string + gettext("Please confirm your selection. ");
      modal = horizon.modals.create(title, body, action_string);
