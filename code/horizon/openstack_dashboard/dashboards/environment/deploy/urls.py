...
urlpatterns = patterns(
    ...
    url(CLUSTER % 'allocatehost',
        ...
        name='allocatehost'),
    url(CLUSTER_HOST % 'update_host_name',
        select_host_views.UpdateHostNameView.as_view(),
    ...
    url(CLUSTER % 'net_mapping_check',
        network_mapping_views.net_mapping_check,
        name='net_mapping_check'),
    url(CLUSTER % 'bonding',
