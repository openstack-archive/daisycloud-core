...
from daisy.api.v2.model.metadef_namespace import Namespace
from daisy.api.v2.model.metadef_namespace import Namespaces
...
def get_collection_schema():
    ...
    return daisy.schema.CollectionSchema('namespaces', namespace_schema)
