...
from daisy.api.v1 import upload_utils
...
class Controller(controller.BaseController):
    ...
    def _upload(self, req, image_meta):
        ...
        daisy. If the `x-image-meta-store` header is set, Glance
    ...
    def _get_size(self, context, image_meta, location):
        ...
        try:
            ...
            # do with daisy. If log.exception is used here, in that case the
    ...
    def create(self, req, image_meta, image_data):
        """
        Adds a new image to daisy. Four scenarios exist when creating an
        image:
