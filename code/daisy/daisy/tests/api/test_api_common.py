    ...
    def test_valid_network_range(self):
        ...
        try:
            ...
            msg = "%s:%d and %s:%d must be in %d~%d and start:%d less than end:%d"\
                      %(vlan_start,value_start,vlan_end,value_end,range[0],range[1],value_start,value_end)
            self.assertEqual(e.explanation,msg)
        ...
        try:
            ...
            msg = "%s:%d and %s:%d must be in %d~%d and start:%d less than end:%d"\
                      %(svlan_start,value_start,svlan_end,value_end,range[0],range[1],value_start,value_end)
            self.assertEqual(e.explanation,msg)
