...
all_hosts = [
    {
        ...
        },
        {
            ...
            "disks": {
                ...
                "docker-253-0-4196035-b6b9e884de6206632893d8fe5c056158ea2d2c 99453f600742c5dc7437f5775e": {
                    "name": "docker-253:0-4196035-b6b9e884de6206632893 d8fe5c056158ea2d2c99453f600742c5dc7437f5775e",
                    "extra": [
                        "",
                        ""
                    ],
...
def stub_get_hosts_detail(context, **params):
    return [{"id":"c8a6f556-fcaa-45ee-9e9f- cce11b6bda07"},{"id":"dd68c9a0-7c95-424a-bff7-d610d7393dad"}]
