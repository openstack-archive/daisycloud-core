           ...
           {'services':
            ...
            'host_interfaces':
                [{'management': {'ip': '192.168.1.3',
                                 'netmask': "255.255.255.0", 'name': 'eth0', },
...
class TestTecsConfig(unittest.TestCase):
    ...
    def setUp(self):
        tecs_config.tecs_conf_template_path = os.path.dirname(
            os.path.realpath(__file__))
        print tecs_config.tecs_conf_template_path

    def tearDown(self):
        tecs_config.tecs_conf_template_path = \
            tecs_config.default_tecs_conf_template_path
