...
from daisy.api.backends import os
...
host_detail = {'id': '7739d9d9-93ca-480f-bde4-3b4c1052e63a',
               ...
               'group_list': 'core',
               'disks':{"sda": {"name": "sda", "extra": ["scsi-350000396582a129c", "wwn-0x50000396582a129c"], "removable": "", "model": "", "disk": "pci-0000:01:00.0-sas-0x50000396582a129e-lun-0", "size": " 600127266816 bytes"}, 
               "sdb": {"name": "sdb", "extra": ["scsi-35000039668110618", "wwn-0x5000039668110618"], "removable": "", "model": "", "disk": "pci-0000:01:00.0-sas-0x500003966811061a-lun-0", "size": " 600127266816 bytes"}},
               'interfaces': [
                   ...
                   {'assigned_networks': [{'ip': '192.168.1.3',
                    ...
                    'slave2': None, 'type': 'ether',
                    'vswitch_type': ''}],
                'memory': {"total": "       264122576 kB", "phy_memory_1": {"maximum_capacity": " 256 GB", "devices_5": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "devices_4": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "devices_7": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "devices_6": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "devices_1": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "devices_3": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "devices_2": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}, "slots": " 8", "devices_8": {"frequency": " 1333 MHz", "type": " DDR3", "size": " 16384 MB"}}, }}
...
class TestHostTemplate(test.TestCase):
    ...
    def test_get_host_template_detail(self):
        ...
        req.context = RequestContext(is_admin=True,
                                     ...
                                     tenant='fake tenant')
        template_id = "123"
        registry.host_template_detail_metadata = mock.Mock(return_value={"host_template_name":"test"})
        host_template_meta = self.controller.get_host_template_detail(req, template_id)
        self.assertEqual("test", host_template_meta['host_template']['host_template_name'])
    ...
    def test_update_host_template(self):
        ...
        template_id = "123"
        host_template = {}
        registry.update_host_template_metadata = mock.Mock(return_value={"host_template_name":"test"})
        host_template_meta = self.controller.update_host_template(req, template_id, host_template)
        self.assertEqual("test", host_template_meta['host_template']['host_template_name'])
    ...
    def test_add_host_template(self):
        ...
        registry.add_host_template_metadata = mock.Mock(return_value={"host_template_name":"test"})
        host_template_meta = self.controller.add_host_template(req, host_template)
        self.assertEqual("test", host_template_meta['host_template']['host_template_name'])
    ...
    def test_get_host_template_lists(self):
        ...
        req.context = RequestContext(is_admin=True,
                                     user='fake user',
                                     tenant='fake tenant')
        self.controller._get_query_params = mock.Mock(return_value={'filter':{}})
        host_template = {"host_template_name":"test"}
    ...
    def test_host_to_template(self):
        ...
        host_template_meta = self.controller.host_to_template(req, host_template)
        self.assertEqual('test', host_template_meta['host_template']['host_template_name'])
    ...
    def test_template_to_host(self):
        ...
        host_template = {'host_template_name': 'test'}
        self.get_host_meta_or_404 = mock.Mock(return_value=host_detail)
        self.assertRaises(HTTPNotFound, self.controller.template_to_host, req, host_template)
    ...
    def test_template_to_host_with_no_pxe_hwm(self):
        ...
        req.context = RequestContext(is_admin=True,
                                     user='fake user',
                                     tenant='fake tenant')
        host_template = {'host_template_name': 'test','cluster_name': "11", 'host_id': "123"}
        ...
        registry.host_template_lists_metadata = mock.Mock(return_value=[{'hosts': hwm_host_detail}])
        self.assertRaises(HTTPForbidden, self.controller.template_to_host, req, host_template)
    ...
    def test_template_to_host_with_pxe_hwm(self):
        ...
        self.get_host_meta_or_404 = mock.Mock(return_value=hwm_host_detail)
        registry.get_host_metadata = mock.Mock(return_value=hwm_host_detail)
        registry.host_template_lists_metadata = mock.Mock(return_value=[{'hosts': json.dumps([hwm_host_detail])}])
        registry.get_clusters_detail = mock.Mock(return_value=[{'id': '1'}])
        self.controller._judge_ssh_host = mock.Mock(return_value={'2'})
        daisy_cmn.add_ssh_host_to_cluster_and_assigned_network = mock.Mock(return_value={})
        result = self.controller.template_to_host(req, host_template)
        actual = {'host_template': {'cluster_name': '11', 'host_id': '123', 'host_template_name': 'test'}}
    ...
    def test_template_to_host_with_ssh(self):
        ...
        registry.host_template_lists_metadata = mock.Mock(return_value=[{'hosts': json.dumps([host_detail])}])
        registry.get_clusters_detail = mock.Mock(return_value=[{'id': '1'}])
    ...
    def test_delete_host_template(self):
        ...
        host_template = {'host_template_name': 'test'}
        self.get_host_meta_or_404 = mock.Mock(return_value=host_detail)
        self.assertRaises(HTTPNotFound, self.controller.delete_host_template, req, host_template)
    ...
    def test_delete_host_template_with_host_template_null(self):
        ...
        req.context = RequestContext(is_admin=True,
                                     user='fake user',
                                     tenant='fake tenant')
        host_template = {'host_template_name': 'test', 'cluster_name':"cluster"}
        registry.host_template_lists_metadata = mock.Mock(return_value=[])
        self.assertRaises(HTTPNotFound, self.controller.delete_host_template, req, host_template)
