...
class TestHostsApiConfig(test.TestCase):
    ...
    def setUp(self):
        ...
        self.return_meta_of_get_host = {'host':
            {
                u'os_version_id': None,
                u'config_set_id': None,
                u'root_disk': u'sda',
    ...
    # @mock.patch('daisy.registry.client.v1.client.RegistryClient.do_request')
    # def test_get_os_version_type_when_input_os_version_file(self,
    #                                                         mock_do_request):
    #     os_version = '/var/lib/daisy/redhat123.iso'
    #     req = webob.Request.blank('/')
    #     req.context = RequestContext(is_admin=True,
    #                                  user='fake user',
    #                                  tenant='fake tenant')
    ...
    def test_verify_host_cluster_with_no_discover(self):
        ...
        self.controller.get_cluster_meta_or_404 = \
            mock.Mock(return_value={"id": "66e57b5c-fc4f-4c09-a550-b057ff4f5452"})
    ...
    def test_check_interface_on_update_host(self):
        ...
        orig_host_meta = {"cluster":"test_host",
                     "interfaces":[
                        {
                            "name": "enp3s0f0",
                            "is_deployment": False,
        ...
        result = self.controller._check_interface_on_update_host( req, host_meta, orig_host_meta)
...
class TestGetClusterNetworkInfo(test.TestCase):
    ...
    def test_verify_host_cluster_with_in_cluster(self):
        ...
        daisy_cmn.check_discover_state_with_hwm = \
            mock.Mock(return_value=check_result(host_meta, 'SSH:DISCOVERY_SUCCESSFUL'))
        self.assertRaises(webob.exc.HTTPForbidden,
                          self.controller._verify_host_cluster, req,
                          "840b92ab-7e79-4a7d-be0a-5e735e0a836e",
                          orig_host_meta, host_meta)
