...
def define_discover_hosts_table(meta):
    discover_hosts = Table('discover_hosts',
                  ...
                  Column('passwd', String(36), nullable=False),
...
def define_networks_table(meta):
    networks = Table('networks',
                     ...
                     Column('vlan_start', Integer(),nullable=False, default=1),
                     Column('vlan_end', Integer(),nullable=False, default=4094),
                     Column('ip', String(256)),
                     Column('gateway', String(128)),
                     Column('type', String(36), nullable=False, default='default'),
...
def define_roles_table(meta):
    roles = Table('roles',
                     ...
                     Column('disk_location', String(255), nullable=False, default='local'),
