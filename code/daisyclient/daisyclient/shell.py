...
class DaisyShell(object):
    ...
    def _append_global_identity_args(self, parser):
        ...
        parser.add_argument('-k', '--insecure',
                            default=False,
                            action='store_true',
                            help='Explicitly allow daisyclient to perform '
    ...
    def _get_versioned_client(self, api_version, args, force_auth=False):
        ...
        client = daisyclient.Client(api_version, endpoint, **kwargs)
        return client

    def _cache_schemas(self, options, home_dir='~/.daisyclient'):
    ...
    def main(self, argv):
        ...
        LOG = logging.getLogger('daisyclient')
    ...
    def do_bash_completion(self, _args):
        ...
        daisy.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
...
def main():
    try:
        DaisyShell().main(map(encodeutils.safe_decode, sys.argv[1:]))
